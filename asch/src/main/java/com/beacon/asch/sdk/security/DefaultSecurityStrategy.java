package com.beacon.asch.sdk.security;

import com.beacon.asch.sdk.AschSDKConfig;
import com.beacon.asch.sdk.codec.Base58;
...
import com.beacon.asch.sdk.security.ripemd.RipeMD160;
...
public class DefaultSecurityStrategy implements SecurityStrategy{
    ...
    public int getTransactionTimestamp() {
        ...
        return (int)((System.currentTimeMillis() - AschConst.ASCH_BEGIN_EPOCH.getTime())/1000 - AschConst.CLIENT_DRIFT_SECONDS);
    }
